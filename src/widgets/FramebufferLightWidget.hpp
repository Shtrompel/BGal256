#ifndef _FB_LIGHT_WIDGET
#define _FB_LIGHT_WIDGET

#include "plugin.hpp"

struct FramebufferLightWidget : public ModuleLightWidget 
{
    struct Internal2;
	Internal2* internal2;

	bool dirtySubpixelChange = 0; // APP->window->fbDirtyOnSubpixelChange()
	float windowRatio;
